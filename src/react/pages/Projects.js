...
import livranoSite from "../../assets/thumbnails/LIVRANO.jpg";
...
const Projects = () => {
  return (
    <main>
      ...
      <ProjectCard title="Livrano.com" className="double" collapse>
      ...
      <ProjectCard title="AutoCAD Manual of Style">
        {/* <img src={livranoSite} alt="Livrano.com displayed on a laptop." className="thumb"/> */}
        <p>
          A style guide and reference document for AutoCAD.
        </p>
        <p>
      ...
      <ProjectCard title="Studio Cutelo website">
        <p>
